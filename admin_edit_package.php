<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if(isset($_POST['update_button'])){
      $sql = "UPDATE package SET destination='$destination', aperture_from='$aperture', date='$date', price=$price, package_limit=$seat, package_details='$details' WHERE package_id=$packID";
                  ...
                  <table>
                    <tr>
                      <td align="center">
                        ...
                        <input type="text" name="destination" placeholder="Destination" value="<?php echo $row['destination']; ?>" class="input_box"> <br>
