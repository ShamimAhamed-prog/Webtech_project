...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  $sqlPrs = "select * from pack_request WHERE agent_id='$userID' LIMIT $i, $j;";
  ...
  */
  ...
  $sqlTotalRows = "select count(*) as total_rows from pack_request WHERE agent_id='$userID';";
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
          <table>
            <tr class="top_section_head" align="center">
              <td class="td" colspan="4">Accepted Package Requests</td>
            </tr>
          </table>
        </form>
      </div>
